// fonction qui permet de récupérer les données des photographes 
function photographerFactory(data) {
    ...
    // je créer une fonction qui regroupe tous les éléments à afficher
    ...
    // retourne les données du photographe et les fonctions de création du DOM
    return { name, picture, getUserCardDOM }
}

//exporte la fonction photographerFactory
